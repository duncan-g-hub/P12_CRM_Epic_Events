...
def display_event_form(supports, customers, contracts):
    ...
    date_start = input("Veuillez saisir la date de début de l'événement (JJ/MM/AAAA) : ")

    date_end = input("Veuillez saisir la date de fin de l'événement (JJ/MM/AAAA) : ")
    ...
    return name, support_id, customer_id, contract_id, date_start, date_end, location, attendees, notes
